...
* [PCSM-249](https://perconadev.atlassian.net/browse/PCSM-249): Fixed incorrect handling of events generated by a `movePrimary` operation. The issue could cause data on the target cluster to differ from the source after `movePrimary`.
