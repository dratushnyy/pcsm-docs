...
In the event of an active instance failure, one of passive instances will take over. The replication will then continue from the last checkpoint to minimize any disruption and prevent manual intervention.
